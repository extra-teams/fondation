  ...
  <div style="background-color:#FFFFFF;">
    ...
    <div style="background:#356cc7;background-color:#356cc7;margin:0px auto;max-width:600px;">
      ...
      <![endif]-->
                  ...
                  @php
                      $l1 =array();
                      $d=\DB::table('detailcommandes')->where('id_commande',$id_commande)->get();
                            foreach ($d as $key => $value) {
                                $prod= \DB::table('produits')->where('code',$value->code_prod)->first();
                                for ($i=0; $i <$value->quantite ; $i++) { 
                                  array_push($l1,$prod->owner_id);
                                }
                        }
                        $t=array_count_values($l1);
                  @endphp 
                  @foreach($t as $k=>$f)
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:18px;line-height:1;text-align:left;color:#FFFFFF;">Total : {{ $montant }} Fcfa</div>
                    </td>
                  </tr>
                </table>
              </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="background:#FFFFFF;font-size:0px;padding:10px 25px;padding-top:20px;padding-right:25px;padding-bottom:20px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:15px;line-height:1;text-align:center;color:#555555;"><a href="https://fondation225.ci"> fondation225, s'habillé comme dans ses rêves</a></div>
                    </td>
                  </tr>
                </table>
              </div>
