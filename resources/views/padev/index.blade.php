...
@section('content')
    ...
    <div class="container-fluid p-0 mb-5">
        ...
        <div class="bg-m d-block d-lg-none" style="height: 120vh;background-size: cover;">
            <div class="bg-image"></div>
            <div class="d-block d-lg-none bg-text2 font-weight-bold position-absolute text-center"
                 style="color: white;top: 30%;z-index: 2;width: 90%;font-family: 'Rubik', sans-serif;">
                <h1>PADEV est une initiative de la fondation 225</h1>
            </div>
                    ...
                    <div class='card__content padding-large--l'>
                        <div class="item">
                            ...
                            <p>
                                ...
                                conjurer les maux
                                que sont les guerres civiles, la violence politique, la famine, les épidémies,
                                l’analphabétisme,
                                la pauvreté, etc. qui donnent à ce continent cette identité si peu valorisante, pour en
                                faire une
                                terre qui fait la fierté de ses fils et filles ?<br><br>Ces questions d’une prégnante
                                actualité, et surtout
                                les réponses à leur apporter, ont donné lieu à maintes réflexions et actions depuis les
                                indépendances.
                                Mais alors, comment expliquer qu’après 50 ans, le désert politique, économique, social,
                                sanitaire,
