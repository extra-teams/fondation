...
<div class="container-fluid  mb-5">
  ...
  <form action='{{route('padev.traitement')}}' class='form'>
    ...
    <p class='field'>
      ...
      <select class='select' id='select_country' name="pays">
    ...
    <p class='field half'>
      ...
      <select class='select' id='select' name="secteur">
        <option selected value=''></option>
    ...
    <p class='field half'>
      ...
      <input class='text-input' id='name' name='nom_entreprise' required type='text' value='Use Tab'>
    </p>
    ...
    <p class='field half'>
      ...
      <input class='text-input' id='name' name='nbre_representation' required type='text'>
    </p>
    <p class='field half'>
      <label class='label required' for='name'>Nombre d'employés Africain</label>
      <input class='text-input' id='name' name='nbre_employe' required type='text'>
    </p>
    <p class='field half'>
      <label class='label required' for='name'>Nombre d'employé Africain

      </label>
      <input class='text-input' id='name' name='nbre_employes' required type='text'>
    </p>
    {{-- <div class='field'>
    ...
    <p class='field'>
      ...
      <textarea class='textarea' cols='50' id='about' name='impact' rows='3'></textarea>
    </p>
    <p class='field'>
      <label class='label' for='about'>PALMARES DE VOTRE ENTREPRISE</label>
      <textarea class='textarea' cols='50' id='about' name='palmares' rows='2'></textarea>
    </p>
